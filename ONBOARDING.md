...
|--------|---------|-----------|----------|-------|
| `fortiaiAgenticAssistant` ("FortiSOAR SOC Assistant") | 1.2.52 | `connector-fsr-soc-assistant` 0.5.104 | 2.8.0 | SOC copilot: investigate -> hunt -> triage -> build |
| `socAssistantMonitor` | 1.0.9 | `connector-fsr-soc-assistant` 0.5.104 | 2.8.0 | the assistant's monitoring surface |
